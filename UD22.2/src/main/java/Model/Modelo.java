...
public static String db = "MVCclientes";
	//METODO QUE ABRE LA CONEXION CON SERVER MYSQL
		public static void openConnection() {
			...
			try {
				String user = "remote", password = "Reus.2022";
				Class.forName("com.mysql.cj.jdbc.Driver");
				conexion=DriverManager.getConnection("jdbc:mysql://192.168.1.102:3306?useTimezone=true&serverTimezone=UTC",user,password);//credenciales temporales
